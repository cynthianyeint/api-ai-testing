"""
Django settings for apiai_django_bot project.
...
SECRET_KEY = 'o93#$ro5m^((uyegshjn1hf$wh@a_#n#)@jn%qlr))@o9lt@d1'
...
ROOT_URLCONF = 'apiai_django_bot.urls'
...
WSGI_APPLICATION = 'apiai_django_bot.wsgi.application'
